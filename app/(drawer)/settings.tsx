...
export default function SettingsScreen() {
    ...
    return (
        <View className="flex-1 bg-bg px-6 pt-6">
            {/* Cloud Sync Section */}
            <Text className="mb-4 text-xs uppercase tracking-widest text-muted">Cloud Backup</Text>
            ...
            <View className="rounded-2xl border border-border bg-surface2 p-4">
                ...
                >
                    {isSyncing ? (
                        ...
                        <Text className="text-sm font-medium text-accent">Sync Now</Text>
                    )}
                </TouchableOpacity>

                <Text className="mt-3 text-center text-[11px] text-muted">
                    Pushes local data to Supabase, then pulls any changes from cloud.
                </Text>
            </View>
            ...
            <View className="rounded-2xl border border-border bg-surface2 p-4">
                ...
                <View className="flex-row items-center justify-between">
                    ...
                    <Text className="text-sm text-muted">Gemini 3.5 Flash</Text>
                </View>
                <View className="my-3 h-px bg-border" />
                <View className="flex-row items-center justify-between">
