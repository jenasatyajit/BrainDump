...
import { Modal, View, Text, TextInput, TouchableOpacity, ScrollView, Linking, KeyboardAvoidingView, Platform } from 'react-native';
                                ...
                                <View className="mb-6">
                                    ...
                                    <View className="flex-row gap-2">
                                        {STATUS_OPTIONS.map((opt) => (
                                            <TouchableOpacity
                                                key={opt}
                                                className={`flex-1 rounded-xl border-[1.5px] py-3 ${status === opt
